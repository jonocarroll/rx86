...
See [this]() blogpost, but I wanted to be able to 'run' some x86 assembly code and 
...
* This was built so support a single use-case of solving the puzzle described in 
